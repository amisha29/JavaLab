...
//		String query =  "SELECT  RepNo ,  RepName FROM  Representative, Customer WHERE Customer.RepNo = Representative.RepNo  AND Customer.Credit_Limit >6000 GROUP BY  RepNo";
